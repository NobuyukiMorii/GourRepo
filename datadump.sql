...
CREATE TABLE `restaurants` (
  ...
  `access_walk` int(11) DEFAULT NULL,
  ...
  `code_category_code_I` varchar(255) DEFAULT NULL,
  `code_category_code_I_order` int(11) DEFAULT NULL,
  `code_category_name_I` varchar(255) DEFAULT NULL,
  `code_category_name_I_order` int(11) DEFAULT NULL,
  `code_category_code_s` varchar(255) DEFAULT NULL,
  `code_category_code_s_order` int(11) DEFAULT NULL,
  `code_category_name_s` varchar(255) DEFAULT NULL,
  `code_category_name_s_order` int(11) DEFAULT NULL,
...
-- Dump completed on 2015-03-08  9:12:00
